...
//            console.log('ruleForm', that.ruleForm.hotTemplateId);
        ...
        contractService.getOneTemplate(id).then(function (res) {
          ...
          if(res.data.success){
            ...
            that.ruleForm = {
              ...
              questions_en  : obj.questions_en || [],
              catalogue: obj.catalogue, // 目录
              catalogue_en: obj.catalogue_en, // 目录
        ...
        contractService.getTemplateType({type: 2}).then(function (res) {
          ...
          if(res.data.success){
            that.bType = res.data.datas;
              that.bType.unshift({id:"",name:'不选择'})
          }else{}
        });
      },
      // 获取国家列表
      ...
      getHotDogTemplateType () {
        ...
        contractService.getHotDogsTemplate().then(function (res) {
          ...
          if(res.data.success){
            ...
            that.hotDog.unshift({DisplayName:'不选择',Id:''})
          }else{}
        });
      },
      // 产品包
